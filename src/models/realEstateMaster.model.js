   ...
   * Mirrors the legacy registration INSERT (~80 fields). Any field not
   ...
   async create(data) {
     ...
     await db.insert(realEstateMaster).values({
       ...
       dateOfEc: parseDate(data.dateOfEc),
       nodalPerson: data.nodalPerson ?? "",
       dateOfInstallationAqms: parseDate(data.dateOfInstallationAqms),
       dateOfInstallationWqms: parseDate(data.dateOfInstallationWqms),
       dateOfInstallationAnms: parseDate(data.dateOfInstallationAnms),
       dateOfInstallationNoise: parseDate(data.dateOfInstallationNoise),
       dateOfAutoComposter: parseDate(data.dateOfAutoComposter),
